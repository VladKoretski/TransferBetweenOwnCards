...
**Вы можете познакомиться с некоторыми подсказками [по реализации этой задачи](balance.md)**.  https://github.com/netology-code/aqa-homeworks/blob/master/bdd/balance.md 
